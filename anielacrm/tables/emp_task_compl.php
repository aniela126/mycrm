...
class TaskCompl extends Common
{
	...
	protected function displayHtml()
	{
		...
		$link = "emp_task_compl";
		$tableName = (isset($_GET['gn']) && $_GET['gn'] !== '') ? $_GET['gn'] : 'emp_task_compl';
		include 'menu.php';
	...
	protected function initiateEditor()
	{
		...
		$this->Editor->setConfig('tableTitle','My completed tasks');
		$this->Editor->setConfig('addRowTitle','<div class="text-center"><h1>Add new task</h1></div>');
		...
		$this->Editor->setConfig('sqlFilters',"EXECUTOR_ID=" . $_SESSION['user_id'] . " 
		and task_status_ref.TASK_STAT_DESC='Completed'"); 
	}

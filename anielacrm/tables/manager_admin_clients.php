...
class TaskCompl extends Common
{
	...
	protected function displayHtml()
	{
		...
		$link = "manager_admin_clients";
		
		$tableName = (isset($_GET['gn']) && $_GET['gn'] !== '') ? $_GET['gn'] : 'manager_admin_clients';
	...
	protected function initiateEditor()
	{
		...
		$this->Editor->setConfig('tableTitle','<div class="text-center"><h1>Clients</h1></div>');
		$this->Editor->setConfig('addRowTitle','Add new client');

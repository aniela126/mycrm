...
class TaskCompl extends Common
{
	...
	protected function displayHtml()
	{
		...
		$link = "manager_tasks_compl";
		
		$tableName = (isset($_GET['gn']) && $_GET['gn'] !== '') ? $_GET['gn'] : 'manager_tasks_compl';
		include 'menu.php';
	...
	protected function initiateEditor()
	{
		...
		$this->Editor->setConfig('tableTitle','<div class="text-center"><h1>My completed tasks</h1></div>');
		...
		$this->Editor->setConfig('sqlFilters',"AUTHOR_ID= " . $_SESSION['user_id'] . " and task_status_ref.TASK_STAT_DESC='Completed'"); 
	}

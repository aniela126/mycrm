...
class TaskCompl extends Common
{
	...
	protected function displayHtml()
	{
		...
		$link = "manager_tasks_current";
		
		$tableName = (isset($_GET['gn']) && $_GET['gn'] !== '') ? $_GET['gn'] : 'manager_tasks_current';
		include 'menu.php';
	...
	protected function initiateEditor()
	{
		...
		$this->Editor->setConfig('sqlFilters',"AUTHOR_ID= " . $_SESSION['user_id'] . " and task_status_ref.TASK_STAT_DESC='Open'"); 
	}
